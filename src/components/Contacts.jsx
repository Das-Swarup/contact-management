...
import { addContact } from '../Redux/Add_Contacts/addContacts.action'
        ...
        <Box padding={"30px"} margin={'auto'} w={"79%"} h={"100%"} boxShadow={"rgba(0, 0, 0, 0.24) 0px 3px 8px"} border={"1px solid gray"} >
          ...
          <Box>
            {
              flag ?
                <form onSubmit={handleSubmit} id="form">
                  <Heading onClick={onClose} cursor={"pointer"}>Close</Heading>
          ...
          {data.length < 1 ?
            <Box id="empty" margin={"auto"} marginTop={"4%"} width={"50%"} border={"1px solid gray"}>
              <Heading color={"black"}>No Contact Found Please add contact from Create Contact Button</Heading>
            </Box> :
            <Box marginTop={"4%"}>
